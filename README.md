...
> [!NOTE]
> For info on migrating to v2 of the tool see [this page](https://docs.sqd.dev).

A tool that configures Hasura to track all database tables that have [TypeORM models](https://docs.devsquid.net/sdk/reference/schema-file/intro/#typeorm-codegen) in [SQD indexers](https://docs.sqd.dev/en/sdk).
